...
def search_x(
    ...
    """Search X for relevant posts using xAI API or OpenRouter.

    Args:
        api_key: xAI or OpenRouter API key
        model: Model to use
        topic: Search topic
        ...
        use_openrouter: If True, use OpenRouter endpoint instead of xAI
    ...
    prompt_content = X_SEARCH_PROMPT.format(
        topic=topic,
        from_date=from_date,
        to_date=to_date,
        min_items=min_items,
