...
def _search_x(
    ...
    raw_xai = None
    x_error = None
    # Check both flags - USE_OPENROUTER_FOR_XAI for hybrid mode, USE_OPENROUTER for full OpenRouter mode
    use_openrouter = config.get("USE_OPENROUTER_FOR_XAI", False) or config.get("USE_OPENROUTER", False)
